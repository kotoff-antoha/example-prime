...
function adaptive_header(w){
	...
	if(w<768){
		...
		if ($('.header-bottom-menu--left').hasClass('done')) {
			$('.header-bottom-menu--left').removeClass('done').prependTo($('.header-bottom__column--left'))
		} else {
			if ($('.header-bottom-menu--right').hasClass('done')) {
				$('.header-bottom-menu--right').removeClass('done').prependTo($('.header-bottom__column--right'))
			}
		}
	}
}
